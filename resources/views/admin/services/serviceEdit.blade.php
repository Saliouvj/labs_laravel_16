        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('serviceUpdate', $service) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="title" class="block mt-1 w-full" type="text" name="title" value="{{$service->title}}" required autofocus />
                        </div>
